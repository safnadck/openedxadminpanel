...
"""
application documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'application',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/application/application",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'application'),
                os.path.join(root_path, 'application/migrations')])
